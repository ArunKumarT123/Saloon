                            ...
                            <div className="col-sm-4 mb-1-9 mb-sm-0">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-grow-1 ms-3">
                                        ...
                                        <p className="mb-0 font-weight-600 text-white opacity9 display-30">Job Posted</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4 mb-1-9 mb-sm-0">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-grow-1 ms-4">
                                        ...
                                        <p className="mb-0 font-weight-600 text-white opacity9 display-30">Job Filled</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-sm-4">
                                <div className="d-flex align-items-center">
                                    ...
                                    <div className="flex-grow-1 ms-4">
                                        ...
                                        <p className="mb-0 font-weight-600 text-white opacity9 display-30">Companies</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="container">
                <div className="row mt-n2-6">
                    <div className="col-sm-6 col-lg-3 mt-2-6">
                        ...
                        <p className="mb-1-6 text-white opacity9">Advertise your jobs to hundreds of thousands of monthly customers and seek 15.8 million CV in our database.</p>
                        <ul className="contact-list">
                            <li className="d-flex"><span className="fa fa-home pe-3 text-white"></span><a href="#!">66 Guild Street 512B, Great North Town.</a></li>
                            <li className="d-flex"><span className="fa fa-phone-alt pe-3 text-white"></span><a href="#!">(+44) 123 456 789</a></li>
                            <li className="d-flex"><span className="fa fa-envelope pe-3 text-white"></span><a href="#!">info@example.com</a></li>
                        </ul>
                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="quform-submit-inner">
                                                <button className="btn btn-white text-primary m-0" type="submit"><span><i className="fas fa-paper-plane text-primary"></i></span></button>
                                            </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-7 text-center text-md-start mt-3 mt-md-0 order-2 order-md-1">
                            <p className="d-inline-block text-white mb-0">&copy; <span className="current-year"></span> Job Board Powered by
                                <a href="https://www.chitrakootweb.com/" target="_blank" className="text-primary white-hover">Chitrakoot Web</a>
                            </p>
                        </div>
                        <div className="col-md-5 text-center text-md-end order-1 order-md-2">
                            <p className="text-white d-inline-block mb-0 align-middle">Follow Us :</p>
